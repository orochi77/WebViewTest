        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType, String capture) {
                if ("camera".equals(capture)) {
                    ...
                    Uri cameraPhotoUri = getContentResolver().insert(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, values);
                ...
                if (takePictureIntent.resolveActivity(MainActivity.this.getPackageManager()) != null) {
                    ...
                    if (photoFile != null) {
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                            ...
                            cameraImageUri = FileProvider.getUriForFile(MainActivity.this, packageName + ".fileprovider", photoFile);
                        } else {
